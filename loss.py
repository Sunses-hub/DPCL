...
"""
This code is taken from https://github.com/dewenzeng/positional_cl.git
"""


class SegmentationMetric(object):
    """Computes segmentation metric scores, which are pixAcc, IoU, and Dice."""
...
def batch_pix_accuracy(output, target):
    ...
    predict = predict.cpu().numpy().astype('int64')  #REMVED +1 here and below
